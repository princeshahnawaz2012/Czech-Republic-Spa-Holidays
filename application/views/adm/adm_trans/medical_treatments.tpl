...
<div class="grid_2">
	<p>
		...
		<input type="text" id="art_id" placeholder="ID" value="{$aFilters["medical_treatments.com_medical_treatment_id"]}" />
	</p>
</div>
<div class="grid_6">
	<p>
		<label for="art_title">Title</label>
		<input type="text" id="art_title" placeholder="Title" value="{$aFilters[$sMainLang|cat:"_medical_treatments.title"]}" />
	</p>
</div>
<div class="grid_4">
	<p>
...
{foreach $aMedical_treatments as $medical_treatment}
	<tr class="{cycle values="first,alt"}">
		...
		{foreach $aLangPermissions as $aLang}
			<td>
				{if $medical_treatment[$aLang|cat:"_title"]}
					<a class="edit" href="{$site_url}adm_trans/medical_treatment_edit/{$medical_treatment.com_medical_treatment_id}/{$aLang}" title="Edit this translate"></a>
				{else}
					<a class="new" href="{$site_url}adm_trans/medical_treatment_edit/{$medical_treatment.com_medical_treatment_id}/{$aLang}" title="Input this translate"></a>
				{/if}
			</td>
		{/foreach}
	</tr>	
