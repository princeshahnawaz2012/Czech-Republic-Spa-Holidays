...
{form_open()}
	...
	<fieldset>
		<div class="grid_6">
			...
			<input id="region_title_input" type="text" name="title" value="{set_value('title', $aRegionData.title)}" autocomplete="off" />
		</div>
		<div class="grid_5">
			...
			<select name="com_country_id" id="new_country_title">
				...
				{foreach $aCountries as $aCountry}
					<option value={$aCountry.com_country_id} {set_select('com_country_id', $aCountry.com_country_id, $aCountry.com_country_id == $aRegionData.com_country_id)}>{$aCountry.title}</option>
				{/foreach}
			</select>
		</div>
		<div class="grid_2">
		...
		<div class="grid_3">
			...
			<input type="text" name="com_order" value="{set_value('com_order', $aRegionData.com_order)}" autocomplete="off" />
		</div>
	</fieldset>
	<div class="center">
		<input type="submit" value="{vlang('Save region')}" />
