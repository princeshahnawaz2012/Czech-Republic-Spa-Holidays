$().ready(function() {
		$('textarea.tinymce').tinymce({
			...
			theme_advanced_buttons6 : "hr,removeformat,visualaid,|,sub,sup,|,charmap,emotions,iespell,media,advhr,|,print,|,ltr,rtl,|,fullscreen",
			theme_advanced_buttons7 : "insertlayer,moveforward,movebackward,absolute,|,styleprops,|,cite,abbr,acronym,del,ins,attribs",
			theme_advanced_buttons8 : "jbimages,visualchars,nonbreaking,template,pagebreak",
