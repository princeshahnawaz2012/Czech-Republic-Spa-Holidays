...
var max_width = [];
max_width['map'] = max_map_width;
max_width['flag'] = max_flag_width;
max_width['emblem'] = max_emblem_width;

var max_height = [];
max_height['map'] = max_map_height;
max_height['flag'] = max_flag_height;
max_height['emblem'] = max_emblem_height;
...
var initUploadedImage = function (image_type) {
	$('#' + image_type + '_image_block  .image_block img').Jcrop({
		...
		maxSize: [max_width[image_type], max_height[image_type]],
		bgColor:     'black',
		bgOpacity:   .9
	});
}
