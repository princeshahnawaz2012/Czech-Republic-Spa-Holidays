CREATE TABLE IF NOT EXISTS `en_categories` (
...
CREATE TABLE IF NOT EXISTS `en_cities` (
...
CREATE TABLE IF NOT EXISTS `en_countries` (
  `country_id` mediumint(9) NOT NULL,
  `title` varchar(1025) NOT NULL,
  PRIMARY KEY (`country_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `en_essential_infos` (
...
CREATE TABLE IF NOT EXISTS `en_facilities` (
...
CREATE TABLE IF NOT EXISTS `en_illneses` (
...
CREATE TABLE IF NOT EXISTS `en_medical_treatments` (
...
CREATE TABLE IF NOT EXISTS `en_programmes` (
...
CREATE TABLE IF NOT EXISTS `en_programmes_images` (
  `programme_image_id` int(11) NOT NULL,
  `title` varchar(256) NOT NULL,
  PRIMARY KEY (`programme_image_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `en_regions` (
  `region_id` mediumint(9) NOT NULL,
  `title` varchar(1024) NOT NULL,
  PRIMARY KEY (`region_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `en_rooms` (
  `room_id` mediumint(9) NOT NULL,
  `title` varchar(255) NOT NULL,
  PRIMARY KEY (`room_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `en_room_types` (
  `room_type_id` mediumint(9) NOT NULL,
  `title` varchar(255) NOT NULL,
  PRIMARY KEY (`room_type_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `en_spas` (
...
CREATE TABLE IF NOT EXISTS `en_transfer_stations` (
